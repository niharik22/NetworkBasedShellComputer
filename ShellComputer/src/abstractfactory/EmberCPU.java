        ...
        while (true) {
            ...
            try {
                ...
                if (line.equalsIgnoreCase("yes")) {
                    ...
                    System.out.println("***Class: EmberCPU, Architecture: " + UtilityClass.architecture.name() + ", ProcessName: " + UtilityClass.WERS + ", ProcessState: Terminate, ProcessNumber: " + UtilityClass.processCounter + "***");
                    pm.alterPCB(UtilityClass.WERS, ProcessState.Terminate, UtilityClass.processCounter);
                    break;
                } else if (line.equalsIgnoreCase("no")) {
                    System.out.println("***Class: EmberCPU, Architecture: " + UtilityClass.architecture.name() + ", ProcessName: " + UtilityClass.WERS + ", ProcessState: Running, ProcessNumber: " + UtilityClass.processCounter + "***");
                ...
                Logger.getLogger(EmberCPU.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
}
